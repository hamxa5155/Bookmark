      ...
      <Navbar.Brand href="/main-home">
        <div style={{ display: "inline-flex", marginTop: "5%" }}>
          ...
          <h3 className="navbar-title">
            Book<span style={{ color: "#0FC662" }}>Mark'd</span>
          </h3>
        </div>
      </Navbar.Brand>

      <Nav.Item className={"xl-view"} style={{ marginTop: "0.5%" }}>
        <HashLink className="dark-link" to="/main-home/#how-it-works">
          {" "}
          How it Works
        </HashLink>
        <FiberManualRecordIcon />

        <HashLink className="dark-link" to="/main-home/#our-mission">
          {" "}
          Our Mission
        </HashLink>
        <FiberManualRecordIcon />

        <HashLink className="dark-link" to="/main-home/#contact-us">
          {" "}
          Contact Us
        </HashLink>

        <FiberManualRecordIcon />
        <HashLink className="dark-link" to="/marketplace/#">
          Marketplace
        </HashLink>
        ...
        {/* {isHomePage === "yes" ? (
          <div>
            ...
            <FiberManualRecordIcon />
            <a className="dark-link" href="/marketplace">
              Marketplace
            </a>
          </div>
        ) : (
        ...
        <div>
          {props.user?._id ? (
            <div style={{ display: "inline-flex" }}>
              <Link to="/dashboard">
                <button className="sign-up-button mini-btn-medium">
                  Profile
                </button>
              </Link>
              <Link
                to="/your-backpack"
                style={{ padding: 0, marginTop: "14%" }}>
                <div style={{ position: "relative" }}>
                  {props.cartItems.length > 0 && (
                    <p style={{ position: "absolute", top: -15, right: -10 }}>
            ...
            <>
              <Link to="/log-in">
                <button
                  className="sign-up-button mini-btn-medium"
              ...
              <Link to="/log-in">
                <button
                  className="log-in-button mini-btn-medium"
            ...
            <Grid
              ...
              <Grid item>
                <Link
                  to="/main-home"
                  className="dark-link"
                  onClick={() => history.push("/our-mission")}>
                  Our Mission
                </Link>
              </Grid>
