...
const Faqtable = (props) => {
  ...
  // const [faqEditState, setFaqEditState] = useState({
  //   question: "",
  //   anwser: ""
  // })
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell>#</TableCell>
                <TableCell align="left">Questionb</TableCell>
              ...
              {props?.allfaq?.map((data, index) => {
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{data.anwser}</TableCell>
                    <TableCell align="left"><AiFillEdit className='delete_icon cursor' onClick={() => handleShow()} /></TableCell>
                    <TableCell align="left"><TiDelete className='delete_icon cursor' /></TableCell>
                  </TableRow>
                )
              })}
            </TableBody>
