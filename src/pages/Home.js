                            ...
                            {!submitted ?
                                <div className="contact-us-form__container">
                                    <form className="contact-us-form">
                                        ...
                                        <select name="subject" className="search-bar__container" onChange={(e) => handlechange(e)}>
                                        ...
                                        <div className="contact-us__button-container">
                                            <button type="button" className="contact-us__button" onClick={(e) => handleSubmit(e)}>Submit</button>
                                        </div>
                                    </form>
                                </div>
                                :
