...
import { createContactUs } from "../store/contactUs/actions";
...
function Home(props) {
  ...
  useEffect(() => {
    ...
    else if (isLoggedIn === "yes") setSpacerDiv(false);

    return () => localStorage.setItem("isHomePage", "no");
  }, []);

  const handlechange = (e, image) => {
    console.log("check input data", e.target.value);
    setContactUsState({ ...contactUsState, [e.target.name]: e.target.value });
  };
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await props.createContactUs(contactUsState);
        ...
        <Grid item direction={"row"}>
          <div id="how-it-works" className="how-it-works">
            <div className="how-it-works__inner inner">
              <h2>
                How it <span style={{ fontFamily: "Poppins Bold" }}>Works</span>
              </h2>
              <p>
                We’ve made sure our services are secure and simple. We require
                that all members sign up with .edu emails only and set up
                two-step verification. We only charge{" "}
                <span style={{ fontFamily: "Poppins Bold" }}>
                  10% per transaction
                </span>{" "}
                on the platform, so you can be sure to save most of your
                earnings.
              </p>

              <label className="switch">
                <input
                  id="how-it-works__checkbox"
                  type="checkbox"
                  checked={x}
              ...
              {x ? (
                <HowItWorksIcons
                  ...
                  description2={
                    <h5>
                      ...
                      <br /> your book information
                    </h5>
                  }
                  icon3={PublishListingIcon}
                  description3={
                    <h5>
                      Publish your listing to get
                      <br /> selling!
                    </h5>
                  }
                />
                ...
                <HowItWorksIcons
                  ...
                  description2={
                    <h5>
                      Pay through Stripe
                      <br /> Payment Processor
                    </h5>
                  }
                  icon3={ArrangePickUpIcon}
                  description3={
                    <h5>
                      Arrange pick-up with
                      <br /> seller to get your book
                    </h5>
                  }
                />
              )}
        ...
        <Grid item direction={"row"}>
          <div id="our-mission" className="our-mission">
            <div className="our-mission__inner inner">
              <h2>
                Our <span style={{ fontFamily: "Poppins Bold" }}>Mission</span>
              </h2>
              ...
              <div className="our-mission-quote__container">
                ...
                <div className="our-mission-quote__text">
                  ...
                  <p>
                    In the spring of 2019, Sharod Farmer, an undergraduate at
                    the University of Florida, noticed the barriers, lack of
                    resources, and financial hardships associated with
                    purchasing textbooks. The buying system for purchasing
                    textbooks had remained relatively stagnant in an age of
                    consistent advancement. Farmer saw an opportunity to create
                    a specialized book exchange by keeping the buying
                    transactions personalized. In 2019, he founded BookMark’d,
                    the first-ever textbook exchange created for students by
                    students.
                  </p>
                </div>
              ...
              <h4 className="three-pillars-title">
                We operate on these three pillars:
              </h4>
              ...
              {!submitted ? (
                <div className="contact-us-form__container">
                  <form className="contact-us-form">
                    ...
                    <p>
                      Fill out this form to get in touch with us. We will
                ...
                <div className="welcome-section-text__container contact-us-thanks inner">
                  <div>
                    ...
                    <div className="contact-us-thanks-inner">
                      <img
                        className={matches && "mt-3"}
                        src={ThanksContactImg}
                      />
                      <div className={"after-submit"}>
                        <p>
                          We will respond to your message as soon as possible.
                          In the meantime, feel free to read through our FAQ
                          page to see if that answers any of your other
                          concerns.{" "}
                        </p>
